...
SELECT BOOK.Title, BORROWER.Borrower_name, BORROWER.Address FROM BOOK , BORROWER , BOOK_LOANS , LIBRARY_BRANCH WHERE LIBRARY_BRANCH.Branch_name='Sharpstown' AND LIBRARY_BRANCH.Branch_id = BOOK_LOANS.Branch_id AND BOOK_LOANS.Due_date= 'today' AND BOOK_LOANS.Card_no = BORROWER.Card_no AND BOOK_LOANS.Book_id = BOOK.Book_id;
